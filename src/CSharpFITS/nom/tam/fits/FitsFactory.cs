// <copyright file="FitsFactory.cs" company="Public Domain">
...
namespace nom.tam.fits
{
    ...
    public class FitsFactory
    {
        ...
        /// <summary>Get the current status of ASCII table writing</summary>
        /*
                internal static bool UseAsciiTables
                {
                }
            */
        ...
        internal static BasicHDU HDUFactory(Header hdr, Data d)
        {
            if (d is ImageData)
            {
