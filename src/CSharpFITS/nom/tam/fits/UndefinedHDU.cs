// <copyright file="UndefinedHDU.cs" company="Public Domain">
...
namespace nom.tam.fits
{
	...
	*/
    ...
    {
        /// <summary>Build an image HDU using the supplied data.
        /// </summary>
        /// <param name="obj">the data used to build the image.
        /// </param>
        /// <exception cref=""> FitsException if there was a problem with the data.
        ///
        /// </exception>
		...
		*/
        ...
        /// <summary>Create a Data object to correspond to the header description.
        /// </summary>
        /// <returns> An unfilled Data object which can be used to read
        /// in the data for this HDU.
        /// </returns>
        /// <exception cref=""> FitsException if the image extension could not be created.
        ///
        /// </exception>
