// <copyright file="ActualBufferedStream.cs" company="Public Domain">
...
{
    /// <summary>
    ///   As far as I can tell, System.IO.BufferedStream doesn't do jack squat
    ///   in the way of buffering at least in my .NET installation.  I've tested
    ///   my own inline buffering versus System.IO.BufferedStream versus
    ...
    public class ActualBufferedStream : AdapterStream
    {
        ...
        public ActualBufferedStream(Stream targetStream) : this(targetStream, DEFAULT_BUFFER_SIZE)
        {
        }

        public ActualBufferedStream(Stream targetStream, int bufferSize) : base(targetStream)
        {
