// <copyright file="ImageTiler.cs" company="Public Domain">
...
namespace nom.tam.image
{
    ...
    /// <summary>This class provides a subset of an N-dimensional image.
    ...
    public class ImageTiler
    {
        ...
        /// <param name="base	The">base class (should be a primitive type) of the image.</param>
        ...
        /// <param name="The">starting corner (using 0 as the start) for the image.</param>
        /// <param name="The">length requested in each dimension.</param>
        ...
        /// <param name="start	The">starting corner values.</param>
        /// <param name="current	The">current offsets.</param>
